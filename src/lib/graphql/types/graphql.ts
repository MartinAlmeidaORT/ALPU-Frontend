...
export type CalculateContractMutation = {
  calculateContract: {
    totalPrice: unknown;
    servicePrice: Array<{
      service: string;
      price: unknown;
      totalPriceWithDiscount: unknown;
      variants: number | null;
      pieceName: string;
      serviceFlags: Array<{ isOn: boolean; label: string }>;
    }>;
  };
};
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'ServiceDuration' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                        ...
                        arguments: [
                          {
                            ...
                            value: {
                              ...
                              fields: [
                                {
                                  kind: 'ObjectField',
                                  name: { kind: 'Name', value: 'durationId' },
                ...
                },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'ServiceSpecial' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
...
export const CalculateContractDocument = {
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'CalculateContractInput' },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'servicePrice' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'totalPriceWithDiscount' },
                      },
                      {
                        kind: 'Field',
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'pieceName' },
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'serviceFlags' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'isOn' },
                            },
                            {
                              kind: 'Field',
  ...
  CalculateContractMutation,
  CalculateContractMutationVariables
>;
