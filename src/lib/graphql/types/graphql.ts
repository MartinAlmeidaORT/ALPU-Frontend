...
export type UsersQuery = { users: Array<
    | { userId: number, firstName: string, lastName: string, email: string, rut: string, userState: UserState }
    | { userId: number, firstName: string, lastName: string, email: string, rut: string, userState: UserState }
    | { userId: number, firstName: string, lastName: string, email: string, rut: string, userState: UserState }
    | { userId: number, firstName: string, lastName: string, email: string, rut: string, userState: UserState }
    | { userId: number, firstName: string, lastName: string, email: string, rut: string, userState: UserState }
...
export const UsersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"users"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"state"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UserState"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"users"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"userState"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"state"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"rut"}},{"kind":"Field","name":{"kind":"Name","value":"userState"}}]}}]}}]} as unknown as DocumentNode<UsersQuery, UsersQueryVariables>;
