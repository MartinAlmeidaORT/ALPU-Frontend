...
export type CalculateContractQuery = { calculateContract: { total: unknown, adjustments: Array<{ key: string, type: PriceAdjustmentType, amount: unknown, applyDiscount: unknown }>, services: Array<{ serviceName: string, basePrice: unknown, subsequentPrice: unknown, subTotal: unknown, adjustments: Array<{ key: string, type: PriceAdjustmentType, amount: unknown, applyDiscount: unknown }> }> } };
