...
export type RegisterBroadcasterMutation = { registerBroadcaster: { token: string, user:
      | { __typename: 'Accountant', email: string, firstName: string, lastName: string, rut: string, address: { city: string, street: string | null, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Administrator', email: string, firstName: string, lastName: string, rut: string, address: { city: string, street: string | null, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Broadcaster', email: string, firstName: string, lastName: string, rut: string, address: { city: string, street: string | null, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Client', email: string, firstName: string, lastName: string, rut: string, address: { city: string, street: string | null, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Supervisor', email: string, firstName: string, lastName: string, rut: string, address: { city: string, street: string | null, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
     | null } };
...
export type RegisterClientMutation = { registerClient: { token: string, user:
      ...
      | { __typename: 'Administrator', email: string, firstName: string, lastName: string, rut: string, address: { city: string, street: string | null, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Broadcaster', email: string, firstName: string, lastName: string, rut: string, address: { city: string, street: string | null, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Client', email: string, firstName: string, lastName: string, rut: string, agency: { name: string } | null, address: { city: string, street: string | null, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Supervisor', email: string, firstName: string, lastName: string, rut: string, address: { city: string, street: string | null, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
     | null } };
...
export type LoginMutation = { login: { token: string, user:
      | { __typename: 'Accountant', userId: number, email: string, firstName: string, lastName: string }
      | { __typename: 'Administrator', userId: number, email: string, firstName: string, lastName: string }
      ...
      | { __typename: 'Supervisor', userId: number, email: string, firstName: string, lastName: string }
     | null } };
...
export type CompleteGoogleSignUpBroadcasterMutation = { completeGoogleSignUpBroadcaster: { token: string, user:
      | { __typename: 'Accountant', email: string, firstName: string, lastName: string, rut: string, address: { street: string | null, city: string, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Administrator', email: string, firstName: string, lastName: string, rut: string, address: { street: string | null, city: string, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Broadcaster', email: string, firstName: string, lastName: string, rut: string, address: { street: string | null, city: string, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Client', email: string, firstName: string, lastName: string, rut: string, address: { street: string | null, city: string, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Supervisor', email: string, firstName: string, lastName: string, rut: string, address: { street: string | null, city: string, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
     | null } };
...
export type CompleteGoogleSignUpClientMutation = { completeGoogleSignUpClient: { token: string, user:
      ...
      | { __typename: 'Administrator', email: string, firstName: string, lastName: string, rut: string, address: { street: string | null, city: string, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Broadcaster', email: string, firstName: string, lastName: string, rut: string, address: { street: string | null, city: string, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Client', email: string, firstName: string, lastName: string, rut: string, agency: { name: string } | null, address: { street: string | null, city: string, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
      | { __typename: 'Supervisor', email: string, firstName: string, lastName: string, rut: string, address: { street: string | null, city: string, country: { countryCode: string, name: string }, department: { departmentId: number, name: string } } | null }
     | null } };
...
export type GenerateContractMutation = { generateContract: { client: { firstName: string, lastName: string } } };
