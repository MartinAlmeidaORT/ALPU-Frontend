...
const documents: Documents = {
  ...
  '\n  query contractsFiltered($first: Int, $after: String, $state: ContractState!) {\n    contracts(\n      first: $first\n      after: $after\n      where: { state: { eq: $state } }\n      order: [{ contractId: DESC }]\n    ) {\n      nodes {\n        contractId\n        broadcaster {\n          firstName\n          lastName\n        }\n        client {\n          firstName\n          lastName\n          agency {\n            name\n          }\n        }\n        state\n        date\n        dueDate\n      }\n      pageInfo {\n        hasNextPage\n        hasPreviousPage\n        startCursor\n        endCursor\n      }\n      totalCount\n    }\n  }\n':
    types.ContractsFilteredDocument,
  '\n  mutation UpdateContractState($input: UpdateContractStateInput!) {\n    updateContractState(input: $input) {\n      contractId\n      state\n      broadcaster {\n        firstName\n        lastName\n      }\n      client {\n        firstName\n        lastName\n      }\n    }\n  }\n':
    types.UpdateContractStateDocument,
  '\n  mutation ApproveContract($contractId: Int!) {\n    approveContract(contractId: $contractId) {\n      clientApproved\n      broadcasterApproved\n      state\n    }\n  }\n':
