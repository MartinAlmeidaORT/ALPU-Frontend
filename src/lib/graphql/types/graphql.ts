...
export type ContractState = 'ACTIVE' | 'CANCELED' | 'COMPLETED' | 'PENDING';
...
export type RegisterBroadcasterMutation = {
  registerBroadcaster: {
    token: string;
    user:
      | {
...
export type CompleteGoogleSignUpBroadcasterMutation = {
  completeGoogleSignUpBroadcaster: {
    token: string;
    user:
      | {
          __typename: 'Accountant';
...
export type CompleteGoogleSignUpClientMutation = {
  completeGoogleSignUpClient: {
    token: string;
    user:
      | {
          __typename: 'Accountant';
...
export type ContractsQuery = {
  contracts: {
    ...
    nodes: Array<{
      ...
      date: unknown;
      dueDate: unknown;
      broadcaster: { firstName: string; lastName: string };
      client: {
        firstName: string;
        lastName: string;
        agency: { name: string } | null;
...
export type ContractsFilteredQuery = {
  contracts: {
    totalCount: number;
    nodes: Array<{
      contractId: number;
...
export type UpdateContractStateMutation = {
  updateContractState: {
    contractId: number;
    state: ContractState;
    broadcaster: { firstName: string; lastName: string };
...
export type DashboardQuery = {
  dashboard: {
    ...
    topBroadcasterByContracts: Array<{
      contracts: number;
      user:
    ...
    topClientsByPaidContracts: Array<{
      firstName: string;
      lastName: string;
      paidContracts: number;
    }>;
    monthlyPaidGroup: Array<{
      month: string;
      clients: Array<{
        firstName: string;
        lastName: string;
...
export type ServicesQuery = {
  services: Array<
    | {
        ...
        basePrice: unknown;
        extraPrice: unknown;
        firstExtraPrice: unknown;
      }
    | {
        __typename: 'ServiceIvr';
        additionalMessagePrice: unknown;
        type: ServiceType;
        name: string;
        serviceId: number;
        basePrice: unknown;
...
export type CalculateContractQuery = {
  calculateContract: {
    total: unknown;
    ...
    services: Array<{
      serviceName: string;
      basePrice: unknown;
      subsequentPrice: unknown;
      subTotal: unknown;
      beforeDiscount: unknown;
      pieces: Array<{ name: string; price: unknown }>;
      adjustments: Array<{
        name: string;
        key: string;
        type: PriceAdjustmentType;
...
export type ClientsQuery = {
  clients: Array<{ userId: number; firstName: string; lastName: string }>;
};
...
export const RegisterBroadcasterDocument = {
  ...
  definitions: [
    {
      ...
      operation: 'mutation',
      name: { kind: 'Name', value: 'registerBroadcaster' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'RegisterBroadcasterInput' },
            },
          },
        },
      ],
  ...
  RegisterBroadcasterMutation,
  RegisterBroadcasterMutationVariables
>;
...
>;
export const GoogleAuthDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'googleAuth' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<GoogleAuthMutation, GoogleAuthMutationVariables>;
...
export const CompleteGoogleSignUpBroadcasterDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'CompleteGoogleSignUpBroadcasterInput',
              },
            },
          },
        },
  ...
  CompleteGoogleSignUpBroadcasterMutationVariables
>;
export const CompleteGoogleSignUpClientDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'completeGoogleSignUpClient' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'CompleteGoogleSignUpClientInput' },
            },
          },
        },
      ],
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'broadcaster' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
...
export const ContractsFilteredDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'contractsFiltered' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'ContractState' },
            },
          },
        },
      ],
  ...
  ContractsFilteredQuery,
  ContractsFilteredQueryVariables
>;
export const UpdateContractStateDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateContractState' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'UpdateContractStateInput' },
            },
          },
        },
      ],
  ...
  UpdateContractStateMutationVariables
>;
export const ApproveContractDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'clientApproved' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'broadcasterApproved' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'state' } },
              ],
            },
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'GenerateContract' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'topClientsByContracts' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'topBroadcasterByContracts' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'topClientsByPaidContracts' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'paidContracts' },
                      },
                    ],
                  },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'monthlyPaidGroup' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'month' } },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'lateContracts' },
                            },
                          ],
                        },
                      },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'extraPrice' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'firstExtraPrice' },
                },
                { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'ServiceNarrative' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'rolePrice' },
                      },
                    ],
                  },
                },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'ServiceIvr' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                ...
                },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'ServicePeriod' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
...
export const CalculateContractDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'CalculateContract' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'subsequentPrice' },
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'adjustments' },
...
export const BroadcastersDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'broadcasters' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
